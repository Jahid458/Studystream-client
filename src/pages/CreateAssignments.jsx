...
const AddAssignment = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const formData = { title, description, marks, thumbnail, difficulty, dueDate, email };
      ...
      <section className='p-6 mx-auto bg-white rounded-md shadow-md'>
        ...
        <form onSubmit={handleSubmit}>
          <div className='grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2'>
            ...
            <div>
              <label className='text-gray-700' htmlFor='title'>Assignment Title</label>
              <input
                id='title'
                name='title'
                type='text'
            ...
            <div>
              <label className='text-gray-700' htmlFor='thumbnail'>Thumbnail Image URL</label>
              <input
                id='thumbnail'
                name='thumbnail'
                type='url'
            ...
            <div>
              <label className='text-gray-700' htmlFor='marks'>Marks</label>
              <input
                id='marks'
                name='marks'
                type='number'
            ...
            <div>
              <label className='text-gray-700' htmlFor='difficulty'>Difficulty Level</label>
              <select
                name='difficulty'
                id='difficulty'
                className={`block w-full px-4 py-2 mt-2 text-gray-700 bg-white border ${
